...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
		...
		<form action="getBoard_Write" onsubmit="return WriteNullCheck()">
			<h1>게시글 작성</h1>
			<br><br>
			<table>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" name="title" placeholder="제목을 입력하세요." maxlength="100">
					</td>
				</tr>
				<tr>
					<td>
			...
			<textarea class="ckeditor" id="test" name="text" maxlength="500"></textarea>
			<script type="text/javascript">
