...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div id="get">
      	<form action="getSignup" name="join" onsubmit="return JoinNullCheck()">
			<div id="signup" style="width: 400px; margin-left: 90%">
				...
				닉네임<br>
				<input type="text" name="nickname" id="nickname" readonly maxlength="30">&nbsp&nbsp
				...
				<br><br>
				비밀번호<br>
				<input type="password" name="pw" pattern="(?=.*\d)(?=.*[~`!@#$%\\^&*()-])(?=.*[a-z])(?=.*[A-Z]).{6,20}" title="특수문자와 숫자를 포함한 6-20자 영문 대소문자로 설정하세요" maxlength="30">
				<br><br>
				전화번호<br>
				<input type="tel" name="tel"><br><br>
				메일<br>
				<input type="email" name="mail" maxlength="100"><br><br>
