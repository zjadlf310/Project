...
<script type="text/javascript">
	...
	function IDNullCheck(){
		if(!document.id_search.name.value){
			...
			return false;
		} else if(!document.id_search.tel.value){
			alert("휴대 전화 번호를 입력해주세요.");
			document.id_search.tel.focus();
			return false;
		}
	}
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div id="get">
      	<form action="getClientSearchId" name="id_search" onsubmit="return IDNullCheck()">
			<div class="search" align="center">
				...
				<table>
					...
					<tr>
						<td>휴대 전화</td>
						<td><input type="tel" name="tel"maxlength="30"></td>
					</tr>
				</table>
				<br>
		...
		<form action="getClientSearchPw" name="pw_search" onsubmit="return PWNullCheck()">
			<div class="search" align="center">
				<h3>비밀번호 찾기</h3>
				<hr><br>
				<table>
